      ...
      91387: (e, t, n) => {
        ...
        b && b.setAttribute("aria-hidden", "true"),
          w.addEventListener("submit", (e) => {
            ...
            if (
              ([
                ...Array.from(w.getElementsByClassName("sib-optin")),
                ...Array.from(w.getElementsByClassName("sib-multiselect")),
                ...Array.from(w.getElementsByClassName("sib-checkbox-group")),
                ...Array.from(
                  w.getElementsByClassName("sib-radiobutton-group")
                ),
              ].forEach((e) => {
                const n = e.querySelector(".form__entry"),
              ...
              (t = Array.from(w.getElementsByClassName("sib-select")).reduce(
                g,
                t
              )),
              (t = Array.from(w.getElementsByClassName("sib-input")).reduce(
                Y,
                t
              )),
              (t = Array.from(w.getElementsByClassName("sib-captcha")).reduce(
                L,
                t
              )),
              (t = Array.from(
              ...
              const e =
                  w.querySelector(".sib-loader") || w.querySelector(".loader"),
              ...
              window.grecaptcha && r
                ...
                ? grecaptcha.ready(function () {
                    grecaptcha
                      ...
                      .then(function (e) {
                        if (!("g-recaptcha-response" in w)) {
                          let e = document.createElement("input");
                          e.setAttribute("type", "hidden"),
                            e.setAttribute("name", "g-recaptcha-response"),
                            w.appendChild(e);
                        }
                        (w["g-recaptcha-response"].value = e), k(w);
                      });
                  })
                : k(w);
            }
